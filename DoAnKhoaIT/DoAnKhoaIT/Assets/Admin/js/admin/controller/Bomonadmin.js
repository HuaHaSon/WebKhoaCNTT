...
var bomon = {
    ...
    RegisterEvents: function () {
        //do logic here
        var noidungbomonadd = CKEDITOR.replace('bomonadd_noidung', {
        ...
        $('.btnloadgiaovien').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    CKEDITOR.instances['giaovienadd_thongtin'].setData(response.giaovien.thongtin);
